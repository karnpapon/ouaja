...
CHARACTERS = {
  ...
  'G': {"pos": (95-8, 289 + -26), "nodes": ["N", "T", "B", "H"], "node_index": 0,"offset_pos": pygame.Vector2(0, 0)},
  'H': {"pos": (252-12, 289 + -20), "nodes": ["O", "U", "Y", "C", "I"], "node_index": 0, "offset_pos": pygame.Vector2(0, 0)},
  ...
  'O': {"pos": (405-10, 345 + -20), "nodes": ["P", "V", "Z", "D", "J"], "node_index": 0, "offset_pos": pygame.Vector2(0, -11)},
  'P': {"pos": (558-12, 345 + -26), "nodes": ["K", "Q", "W", "E"], "node_index": 0, "offset_pos": pygame.Vector2(0, 8)},
  ...
  'W': {"pos": (707-12, 401 + -20), "nodes": ["F", "L", "R", "X"], "node_index": 0, "offset_pos": pygame.Vector2(0, -6)},
  'X': {"pos": (858-8, 401 + -20), "nodes": [], "node_index": 0, "offset_pos": pygame.Vector2(0, -6)},

  'Y': {"pos": (404-12, 463 + -26), "nodes": ["D", "J", "P", "V", "Z"], "node_index": 0, "offset_pos": pygame.Vector2(0, 0)},
  'Z': {"pos": (556-10, 463 + -26), "nodes": [], "node_index": 0, "offset_pos": pygame.Vector2(0, 0)},

  '0': {"pos": (92, 464 + -20), "nodes": ["E", "K", "Q", "W"], "node_index": 0,  "offset_pos": pygame.Vector2(0, 0)},
